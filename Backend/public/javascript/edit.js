...
// console.log(localStorage.getItem('currentEditPost'));
...
//     };
//     console.log("current edit post id=",currentEditPost.id);
//     try {
//         const response = await fetch(`/blogGenie/blogs/edit/${currentEditPost.id}`, {
//             method: 'PUT',
//             headers: {
